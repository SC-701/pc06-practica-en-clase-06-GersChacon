...
namespace Abstracciones.Modelos
{
    public class VehiculoBase
    {
        ...
        [StringLength(40, ErrorMessage = "La propiedad color debe ser mayor a 4 caracteres y menos a 40", MinimumLength =
            4)]
        ...
        [Required(ErrorMessage = "La propiedad correo de propietario es requerida")]
        [EmailAddress]
        public string CorreoPropietario { get; set; }
        [Required(ErrorMessage = "La propiedad telefono del propietario es requerida")]
        [Phone]
